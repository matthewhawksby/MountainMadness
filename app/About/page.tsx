...
<<<<<<< HEAD
  ...
  <div className="Header w-96 h-28 left-0 top-0 absolute">
    ...
    <div className="OverlayHeader w-96 h-28 left-0 top-0 absolute bg-orange-300 bg-opacity-40 rounded-tl-3xl rounded-tr-3xl" />
  </div>
...
export default About;
>>>>>>> 5df480699f8164606c0e08efd12dc516e095087a
